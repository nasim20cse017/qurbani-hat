                ...
                <form onSubmit={handleSubmit(handleLogin)}>
                    ...
                    <div className="form-control w-full mb-6 relative">
                        ...
                        <input
                            ...
                            className="input w-full bg-[#F3F3F3] border-none rounded-md h-16 px-5 pr-12 focus:outline-none"
                        />

                        {/* Eye Icon */}
                        <button
                            type="button"
                            className="absolute right-4 top-[70%] -translate-y-1/2 text-gray-600 text-xl z-10"
                    ...
                    <button
                        type="submit"
                        className="btn btn-block bg-green-400 hover:bg-blue-400 text-white border-none rounded-md h-14 text-lg normal-case"
                    >
                        Login
                    </button>
