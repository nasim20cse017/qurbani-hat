...
export default function FeaturedAnimals() {
  ...
  return (
    ...
    <Button
      className="md:w-[250px] btn bg-gradient-to-r from-green-500 to-blue-500 text-white font-semibold shadow-md hover:scale-105 transition-all duration-300 rounded-md px-6 py-3 text-sm sm:text-base  hover:bg-blue-400"
    >
      View All Animals
    </Button>
  </Link>
